...
%data analysis (size, rt or not, etc), implementations used (all),  queries
...
\item LC server: Publishes streams of connections in JSON-LD, using a MongoDB?
\item CSA algorithm: We developed the CSA algorithm in the top of the Linked Connections Framework.
\end{itemize}
...
We ran the experiments on a...

Our experiments can be reproduced using the code at \url{https://github.com/julianrojas87/linked-connections-server} and the testbed and the data at \url{https://github.com/cef-oasis/linkedconnections-tests}


\subsection{A running example: Providing reliable access to NMBS}
