...
%Julian's help is needed. The server will expose both, the historical and the real-time connections 
%explicar como se gestiona el tema de datos stadisticos y datos reales (como una connection static no se tiene en cuenta cuando hay una connection con tiempo real, es por los ids de las estaciones y los departure y arrival time)
...
%move to evaluation design section?
